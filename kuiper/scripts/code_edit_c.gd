...
func code_completion():
	...
	code_completion_requested.connect(func():
		...
		var completions = {
			...
			"long": {"kind": CodeEdit.KIND_CLASS, "insert": "long", "image": VARIABLE},
			"short": {"kind": CodeEdit.KIND_CLASS, "insert": "short ", "image": VARIABLE},
			"signed": {"kind": CodeEdit.KIND_CLASS, "insert": "signed ", "image": VARIABLE},
			"unsigned": {"kind": CodeEdit.KIND_CLASS, "insert": "unsigned ", "image": VARIABLE},
